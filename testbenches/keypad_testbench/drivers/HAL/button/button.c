...
static button_t buttons[BUTTON_COUNT] = {
	//	  Pin	  	ActiveState PE		MsBounce
		{ PIN_ENCODER_0_BUTTON,	BUTTONS_ACTIVE, true,	100 	},
		{ PIN_ENCODER_1_BUTTON,	BUTTONS_ACTIVE, true,	100  	},
		{ PIN_BUTTON0,	BUTTONS_ACTIVE, true,	100  	},
		{ PIN_BUTTON1,	BUTTONS_ACTIVE, true,	100  	},
		{ PIN_BUTTON2,	BUTTONS_ACTIVE, true,	100  	}
};
